...
import com.project.santanderdevweek.excepctions.BusisnessException;
import com.project.santanderdevweek.excepctions.NotFoundException;
...
public class StockService {
    ...
    public StockDTO save(StockDTO dto) {
        ...
        if (optionalStock.isPresent()) {
            throw new BusisnessException(MessageUtils.STOCK_ALREADY_EXISTS);
        }
